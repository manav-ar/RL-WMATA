...
try:
    model = DQN.load("models/dqn_station_placement.zip", env=env)
    print("✅ Loaded trained DQN model")
except FileNotFoundError:
    print("❌ DQN model not found. Please train first with: python -m agents.train_dqn")
    exit(1)
...
print("\n" + "="*60)
print("DQN Selected Stations (with Lat/Long)")
print("="*60)
